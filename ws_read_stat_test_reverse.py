...
def plot_dict(dict_use, save_name, subtitle, use_model = []):
    ...
    for model in use_model:
        ...
        for var in dict_use[model]:
            ...
            labs_use = [str(ws) for ws in dict_use[model][var]]
    ...
    if not os.path.isdir("stats_dir_ws_reverse"):
        os.makedirs("stats_dir_ws_reverse")
    plt.savefig("stats_dir_ws_reverse/" + save_name + ".svg", bbox_inches = "tight")
    plt.savefig("stats_dir_ws_reverse/" + save_name + ".png", bbox_inches = "tight")
    plt.savefig("stats_dir_ws_reverse/" + save_name + ".pdf", bbox_inches = "tight")
    plt.close()
