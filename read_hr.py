        ...
        for plttype in ["all", "best"]:
            ...
            for var in dictio:
                ...
                for model in sorted(set_of_models[plttype]):
                    ...
                    all_labels.add(model.replace("Reference", "Referentni").replace("Linear", "Linearni").replace("Third", "Treći").replace("Twice", "Dvaput").replace("UniTS", "Osnovni").replace("Att", "Pažnja"))
